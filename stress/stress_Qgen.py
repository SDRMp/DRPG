...
api_keys = [  
    ...
    "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", "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", 
    "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", "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", 
...
# Divide DataFrame into chunks and apply different API keys
...
for i, key in enumerate(api_keys):
    ...
    # questions = df_chunk.apply(lambda x: generate_question(key, x['first_half'], x['top3_predicted_labels'], x['significant_words']), axis=1)
